...
public class EditorTexto extends javax.swing.JFrame {
    ...
    private BotaoOk ok;
    private BotaoCancelar cancel;
    private FabricaAbstrataBotoes fabricaBotoes;
    ...
    private void addButtons(String tema){
        ...
        if(tema.equalsIgnoreCase("Tema Sem Icones")){
        	fabricaBotoes = new FabricaBotoesSemIcone();
        }else if(tema.equalsIgnoreCase("Tema Com Icones")){
        	fabricaBotoes = new FabricaBotoesComIcone();
        } 
        
        cancel = fabricaBotoes.criarBotaoCancelar();
        ok = fabricaBotoes.criarBotaoOK();    
